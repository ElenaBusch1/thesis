...
To further validate the stability of the fit against potential statistical fluctuations, \textit{pseudo-data} (also known as \textit{toy data}) are created from the CR data distribution. 
